...
namespace margelo::nitro::dlscan {
  ...
  /**
   * A struct which can be represented as a JavaScript object (OcrObservationSpec).
   */
  struct OcrObservationSpec final {
  public:
  ...
  public:
    OcrObservationSpec() = default;
    explicit OcrObservationSpec(std::string text, double x, double y, double width, double height): text(text), x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const OcrObservationSpec& lhs, const OcrObservationSpec& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ OcrObservationSpec <> JS OcrObservationSpec (object)
  template <>
  struct JSIConverter<margelo::nitro::dlscan::OcrObservationSpec> final {
    static inline margelo::nitro::dlscan::OcrObservationSpec fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::dlscan::OcrObservationSpec(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::dlscan::OcrObservationSpec& arg) {
