///
/// Variant_NullType_LicenseDataSpec.swift
 ...
 */
@frozen
public indirect enum Variant_NullType_LicenseDataSpec {
  case first(NullType)
  case second(LicenseDataSpec)
}

public extension Variant_NullType_LicenseDataSpec {
