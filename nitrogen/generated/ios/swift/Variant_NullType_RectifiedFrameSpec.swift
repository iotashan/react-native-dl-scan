///
/// Variant_NullType_RectifiedFrameSpec.swift
 ...
 */
@frozen
public indirect enum Variant_NullType_RectifiedFrameSpec {
  case first(NullType)
  case second(RectifiedFrameSpec)
}

public extension Variant_NullType_RectifiedFrameSpec {
